...
export default function DashboardPage() {
    ...
    //
    // LOADING STATE (STARTUPS DATA)
    //
    if (userStartups === undefined) {
         return (
            <div className="flex justify-center items-center h-screen text-gray-500">
                <Loader2 className="animate-spin h-6 w-6 mr-2" /> Checking your startups...
            </div>
        );
    }

    // 🛑 NEW LOGIC: RENDER IF NO STARTUPS FOUND
    if (userStartups === null || userStartups.length === 0) {
        return (
            <div className="min-h-screen bg-[#F5F5F5] flex flex-col items-center justify-center px-4 py-10">
                <div className="text-center p-8 bg-white border border-gray-200 shadow-lg rounded-xl max-w-md">
                    <h2 className="text-3xl font-bold mb-3 text-red-500">
                        No Startups Found 🚀
                    </h2>
                    <p className="text-gray-600 mb-6">
                        It looks like you haven't added any startups to your account yet.
                    </p>
                    <Link href="/">
    ...
    return (
        <div className="min-h-screen bg-[#F5F5F5] flex flex-col items-center px-4 py-10">
            ...
            {/* METRIC CARDS */}
            {/* Note: This block implicitly relies on userStartups[0] existing, which is now guaranteed below this point */}
            {getStripeKey?.stripeKey && (
            ...
            {userStartups && userStartups.length > 0 && (
                <div className="w-full max-w-4xl mb-12">
                    {/* Accessing userStartups[0] is safe here */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full justify-items-center">
                {/* Looping over userStartups is safe here because we handle the empty case above */}
